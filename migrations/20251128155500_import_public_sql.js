  ...
  const tables = [
    {
      ...
      columns: [
        ...
        { name: 'province_id', fn: t => t.integer('province_id').notNullable() }
      ]
    },
    {
      name: 'devices',
      columns: [
        ...
        { name: 'total_sensor', fn: t => t.integer('total_sensor') }
      ],
      indexes: (t) => {
        t.index('dinas_id');
        t.index('id_mesin');
    ...
    {
      name: 'mqtt_monitoring',
      columns: [
        { name: 'uuid', fn: t => t.text('uuid').primary() },
        { name: 'id_stasiun', fn: t => t.text('id_stasiun').notNullable() },
        { name: 'time', fn: t => t.timestamp('time', { precision: 6 }).notNullable() },
        { name: 'temperature', fn: t => t.text('temperature') },
        { name: 'do_', fn: t => t.text('do_') },
        { name: 'tur', fn: t => t.text('tur') },
        { name: 'ph', fn: t => t.text('ph') },
        { name: 'bod', fn: t => t.text('bod') },
        { name: 'cod', fn: t => t.text('cod') },
        { name: 'tss', fn: t => t.text('tss') },
        { name: 'depth', fn: t => t.text('depth') },
        { name: 'no3_3', fn: t => t.text('no3_3') },
        { name: 'n', fn: t => t.text('n') },
        { name: 'ct', fn: t => t.text('ct') },
        { name: 'no2', fn: t => t.text('no2') },
        { name: 'orp', fn: t => t.text('orp') },
        { name: 'pump_status', fn: t => t.text('pump_status') },
        { name: 'cv_status', fn: t => t.text('cv_status') },
        { name: 'read_status', fn: t => t.text('read_status') },
        { name: 'updated_at', fn: t => t.timestamp('updated_at', { precision: 6 }).defaultTo(knex.fn.now()) }
      ]
    },
    {
      name: 'paket_data',
      columns: [
        { name: 'id', fn: t => t.increments('id').primary() },
        { name: 'tanggal', fn: t => t.date('tanggal').notNullable() },
        { name: 'nama_paket', fn: t => t.string('nama_paket', 255).notNullable() },
        { name: 'masa_aktif', fn: t => t.string('masa_aktif', 255) },
        { name: 'harga', fn: t => t.decimal('harga', 12, 2).notNullable() },
        { name: 'pic', fn: t => t.string('pic', 255).notNullable() },
        { name: 'created_at', fn: t => t.timestamp('created_at', { useTz: true, precision: 6 }).defaultTo(knex.fn.now()).notNullable() },
        { name: 'updated_at', fn: t => t.timestamp('updated_at', { useTz: true, precision: 6 }).defaultTo(knex.fn.now()) },
        { name: 'station', fn: t => t.string('station', 255) }
      ]
    },
    {
      name: 'provinces',
    ...
    },
    {
      ...
      columns: [
        ...
        { name: 'station_id', fn: t => t.integer('station_id').notNullable() },
        { name: 'time', fn: t => t.timestamp('time', { precision: 6 }).notNullable() },
    ...
    {
      name: 'sensor_inventaris',
      columns: [
        { name: 'id', fn: t => t.increments('id').primary() },
        { name: 'products', fn: t => t.string('products', 255) },
        { name: 'qty', fn: t => t.integer('qty') },
        { name: 'condition', fn: t => t.string('condition', 255) }
      ]
    },
    {
      name: 'sensor_request',
      columns: [
        { name: 'id', fn: t => t.increments('id').primary() },
        { name: 'pic', fn: t => t.string('pic', 255) },
        { name: 'products', fn: t => t.string('products', 255) },
        { name: 'stations', fn: t => t.string('stations', 255) },
        { name: 'quantity', fn: t => t.string('quantity', 255) },
        { name: 'request_date', fn: t => t.timestamp('request_date', { useTz: true, precision: 6 }) },
        { name: 'status', fn: t => t.string('status', 255).defaultTo('pending') },
        { name: 'process_stage', fn: t => t.string('process_stage', 255).defaultTo('persiapan') },
        { name: 'note', fn: t => t.text('note') },
        { name: 'approval_date', fn: t => t.date('approval_date') },
        { name: 'approved_by', fn: t => t.string('approved_by', 255) }
      ]
    },
    {
      name: 'sensor_stock',
      columns: [
        { name: 'id', fn: t => t.increments('id').primary() },
        { name: 'products', fn: t => t.string('products', 255) },
        { name: 'serial_number', fn: t => t.string('serial_number', 255) },
        { name: 'condition', fn: t => t.string('condition', 255) },
        { name: 'date_in', fn: t => t.timestamp('date_in', { useTz: true, precision: 6 }) },
        { name: 'date_out', fn: t => t.timestamp('date_out', { useTz: true, precision: 6 }) }
      ]
    },
    {
      ...
      columns: [
        ...
        { name: 'products', fn: t => t.string('products', 255) },
        { name: 'serial_number', fn: t => t.string('serial_number', 255) },
        { name: 'nama_stasiun', fn: t => t.string('nama_stasiun', 255) },
        { name: 'pic', fn: t => t.string('pic', 255) },
        { name: 'created_at', fn: t => t.timestamp('created_at', { useTz: true, precision: 6 }) },
        { name: 'updated_at', fn: t => t.timestamp('updated_at', { useTz: true, precision: 6 }) }
      ]
    },
    {
      name: 'stations',
    ...
    },
    {
      ...
      columns: [
        { name: 'id', fn: t => t.increments('id').primary() },
        { name: 'tanggal', fn: t => t.date('tanggal').notNullable() },
        { name: 'nama', fn: t => t.string('nama', 255).notNullable() },
        { name: 'kwh', fn: t => t.decimal('kwh', 12, 2).notNullable() },
        { name: 'harga', fn: t => t.decimal('harga', 12, 2).notNullable() },
        { name: 'pic', fn: t => t.string('pic', 255).notNullable() },
        { name: 'created_at', fn: t => t.timestamp('created_at', { useTz: true, precision: 6 }).defaultTo(knex.fn.now()).notNullable() },
        { name: 'updated_at', fn: t => t.timestamp('updated_at', { useTz: true, precision: 6 }).defaultTo(knex.fn.now()).notNullable() },
        { name: 'station', fn: t => t.string('station', 255) }
      ]
    },
    {
